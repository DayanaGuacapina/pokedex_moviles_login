  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      child: MaterialApp(
        ...
        initialRoute: LoginFrame.routeName,

        routes: {
          MainWidget.routeName: (context) => const MainWidget(),
          PokemonDetailsScreen.routeName: (context) =>
              const PokemonDetailsScreen(),
          LoginFrame.routeName: (context) => const LoginFrame(),
          RegistroFrame.routeName: (context) => const RegistroFrame(),
        },
      ),
    );
  }
